...
| [YAML](http://darosh.github.io/angular-swagger-ui-material/#?url=https://cdn.rawgit.com/APIs-guru/api-models/master/APIs/bbc.com/1.0.0/swagger.yaml) | no | example for [swagger-yaml.js](./src/modules/swagger-yaml.js) partially [broken](https://github.com/Orange-OpenSource/angular-swagger-ui/issues/13#issuecomment-189906553) module |
| [Theming Demo](http://darosh.github.io/angular-swagger-ui-material/?primary=blue-grey&accent=grey&warn=pink) | yes | *primary:* blue-grey, *accent:* grey, *warn:* pink |
